...
//        WebElement selectAllContactsCheckbox = driver.findElement(By.xpath("(//span[@class='slds-checkbox--faux'])[1]"));
        WebElement selectRogerContact = driver.findElement(By.xpath("(//a[text()='David Heredia']/ancestor::tr//td/following-sibling::td[@class='slds-cell-edit cellContainer'])[1]"));
