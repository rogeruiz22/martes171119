...
//        WebElement selectAllContactsCheckbox = driver.findElement(By.xpath("(//span[@class='slds-checkbox--faux'])[1]"));
        WebElement selectRogerContact = driver.findElement(By.xpath("(//a[text()='Cristopher Cardenas']/ancestor::tr//td/following-sibling::td[@class='slds-cell-edit cellContainer'])[1]"));
